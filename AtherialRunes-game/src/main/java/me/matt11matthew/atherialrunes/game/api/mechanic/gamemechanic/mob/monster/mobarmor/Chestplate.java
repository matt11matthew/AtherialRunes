...
public class Chestplate implements MobArmor {
    @Override
    public ItemStack get(Tier tier) {
        ...
        File json = new File(Main.getInstance().getDataFolder() + "/values/", "chestplate.json");
        int t = 1;
        JSONObject obj = null;
        try {
        ...
        switch (tier) {
            case TIER_1:
                ...
                name = "&fLeather Chestplate";
                t = 1;
                break;
            case TIER_2:
                type = Material.CHAINMAIL_CHESTPLATE;
                name = "&7Chainmail Chestplate";
                t = 2;
                break;
            case TIER_3:
                type = Material.IRON_CHESTPLATE;
                name = "&3Iron Chestplate";
                t = 3;
                break;
            case TIER_4:
                type = Material.DIAMOND_CHESTPLATE;
                name = "&cDiamond Chestplate";
                t = 4;
                break;
        }
